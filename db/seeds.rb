...
csv.each do |data|
  Athlete.create(id: data["id"].to_i, name: data["name"], grade: data["grade"], sex: data["sex"],
...
csv.each do |data|
  Tournament.create(id: data["id"].to_i, name: data["name"], place: data["place"], start_day: data["start_day"],
...
csv.each do |data|
  RelayResult.create(competition: data["competition"], result: data["result"].empty? || data["result"].to_i.zero? ? nil : data["result"].to_i,
                     ...
                     fourth_athlete_grade: data["fourth_athlete_grade"], established_date: data["established_date"], information: data["information"], condition: data["condition"], official: data["official"] == "true")
end
